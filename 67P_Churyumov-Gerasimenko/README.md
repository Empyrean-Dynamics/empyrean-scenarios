...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Empyrean-Dynamics/empyrean-scenarios/blob/main/67P_Churyumov-Gerasimenko/main.ipynb)

The notebook twin, [`main.ipynb`](./main.ipynb), is rendered on GitHub
with executed outputs — or open it in Colab with the badge above.
